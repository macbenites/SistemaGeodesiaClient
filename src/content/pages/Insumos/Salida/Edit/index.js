import {
  ...
  const EditSupply = ({ modal, setModal }) => {
    ...
    const {updateSupplyOut, articlesSupplies, selectApplicantOut, selectAuthorizerOut, msgUpdateOut
    } = useSelector((state) => state.supplies);
    const dispatch = useDispatch();
  
    useEffect(() => {
      dispatch(fetchArticlesSupplies(updateSupplyOut.salida_cabecera.cod_almacen));
                ...
                <CardContent>
                  <Formik
                    initialValues={{
                      ...
                      cod_solicitador: updateSupplyOut.salida_cabecera.cod_solicitador,
                      cod_autorizador: updateSupplyOut.salida_cabecera.cod_autorizador,
                      ...
                      <Form autoComplete="off">
                        <Grid container spacing={2}>
                          <Grid item xs={12} md={4}>
                            ...
                            >
                              {updateSupplyOut.almacen?.map((supply) => (
                                <MenuItem
                                      ...
                                      <TextField
                                        ...
                                        value={
                                          values.articles[index].cod_art
                                            ? values.articles[index].stock_almacen + parseInt(values.articles[index].cant_art)
                                            : 0
                                        }
                                        label="Stock"
                                        fullWidth
